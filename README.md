...
- Model: `google/gemma-3-27b-it:free` (overridable via `VITE_MODEL` in `.env`)
...
2. Click **Generate Plan** — the app sends your profile to `google/gemma-3-27b-it:free` via OpenRouter.
...
This application uses `google/gemma-3-27b-it:free` via [OpenRouter](https://openrouter.ai/) to generate workout plans.
